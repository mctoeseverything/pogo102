...
export default function QuizGeneratorPage() {
  ...
  const extractPdfText = async (file: File): Promise<string> => {
    // Use pdf.js from CDN for client-side PDF extraction
    const pdfjsLib = await import("pdfjs-dist");
    
    // Set worker source to a stable CDN version (4.4.168 is widely available)
  ...
  const generateQuiz = async () => {
    // TODO: Re-enable AI quiz generation later
    // Currently disabled - button does nothing
    return;
  };
