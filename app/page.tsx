...
import { FileQuestion, LayoutGrid, Sparkles, ArrowRight, GraduationCap } from "lucide-react";
    ...
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <header className="relative z-10 mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-4">
          ...
          <Link href="/classgo" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
            ClassGo
          </Link>
          <ThemeToggle />
        </nav>
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-20 pb-32">
        ...
        >
          ...
          {/* ClassGo Card */}
          <Link href="/classgo" className="group md:col-span-3 lg:col-span-1">
            <div className="relative h-full overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all hover:border-primary/50 hover:bg-card/80">
              <div className="absolute -top-12 -right-12 h-40 w-40 rounded-full bg-primary/10 blur-2xl transition-all group-hover:bg-primary/15" />
              <div className="relative">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10">
                ...
                <h3 className="mb-2 text-2xl font-semibold text-foreground">ClassGo</h3>
                <p className="mb-6 text-muted-foreground">
                  Your complete classroom management solution. 
                  Streamline attendance, assignments, and student progress all in one place.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="rounded-full bg-secondary px-3 py-1 text-xs text-muted-foreground">
                    Coming soon
